...
\begin{arglist}
        filename
                  & The name of the file to be saved. Overwrites existing files\\\hline

        h\_invariant
                  & Whether the simulation should be treated as if h does not
                    vary with time\\\hline
...
\begin{optarglist}
        ...
        P
              &If P\_deriv is "zero" then this does nothing.
                    ...
                    If it is "custom", then P is the P\_a variable at time index 0. & 0\\\hline
