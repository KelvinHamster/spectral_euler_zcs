...
parser.add_argument("-a","--a0", help="initial amplitude", type=float, default=0.2)
...
parser.add_argument("--X0", help="position of the soliton initial condition", type=float, default=30.0)
parser.add_argument("--X1", help="position of the beach toe", type=float, default=60.0)
...
parser.add_argument("-A","--lowpass_speed", help="set how fast the low-pass filter transitions", type=float, default=0.01)
...
sim.run_simulation(plot_dt,args.savestep,data_dir,stop_cond,
    loop_callback=callback, integrator = args.method)
